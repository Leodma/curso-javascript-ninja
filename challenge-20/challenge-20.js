...
/*
    ...
    */
    ...
    `$inputUsername`.
    */
    var $inputUsername = $.querySelector('input[type="text"]');
    ...
    `$inputEmail`.
    */
     var $inputEmail = $.querySelector('input[type="email"]');
    ...
    `$message`.
    */
    var $message = $.querySelector('textarea');
    ...
    */
    function isValidEmail(email){
        var emailRegex = /^[\w+.]+@\w+\.\w{2,}(?:\.\w{0,2})?$/;
        // var validaEmail = email.match(emailRegex).join('');
