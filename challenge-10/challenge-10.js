...
(function(){
    ...
    */
    function showOperationMessage(n1, operador, n2, resultado){
        return  'A operação ' + n1  + operador +  n2 +  ' = ' + resultado;
    };
    ...
    */
    ...
    // teste para uma função mais fácil, sem precisar atribuir os valores das operações para as variáveis.
    function calculo(n1,operador, n2){
        var n1 = Number(n1);
        var n2 = Number(n2);
        if (!isOperatorValid(operador)){
        ...
        if (!n1|| !n2){
            return " Impossível realizar o calculo, verifique os numeros passados";
        };
        var resultado = operation[operador](n1,n2);

        return showOperationMessage(n1, operador, n2, resultado);

    };


    console.log(calculo('10','+',30));
    console.log(calculo(40,'-',30));
    console.log(calculo(10,'*',30));
    console.log(calculo(60,'/',30));
    console.log(calculo(60,'%',30));
    console.log(calculo(60,'.',30));
    console.log(calculo(60,'%',30));
