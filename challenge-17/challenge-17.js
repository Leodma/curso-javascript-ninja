(function(){
    ...
    */
    ...
    console.log(text.replace(/Manuel Marques de Sousa/, 'Leo Alves' ));
    ...
    */
    ...
    console.log(text.replace(/"O Centauro de Luvas"/, function(resultado){
    ...
    */
    ...
    var regexDate = /(\d{2})\sde\s(\w+)\sde\s(\d{4})/g;
