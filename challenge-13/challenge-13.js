(function(){/*
    ...
    */
    ...
    console.log(letras?'Sim, todos os estados dem mais de 7 letras' : 'Nem todos os estados tem mais de 7 letras');
    /*
    ...
    */
    var map = newBrasil.map(function(uf){
            uf.id ++;
            uf.estado += " pertence ao Brasil";
