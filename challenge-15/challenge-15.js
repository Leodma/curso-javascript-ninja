(function(){
  ...
  */
  ...
  var leo = new Person('Leo', 'Dias', 39);
  var kaio = new Person('Kaio', 'Dias', 13);
  var lucas = new Person('Lucas', 'Dias', 9);
  ...
  */
  ...
  console.log(kaio.getFullName(),'tem',kaio.getAge(),'anos.');
  ...
  */
  ...
  console.log(kaio.getFullName(),'agora tem',kaio.getAge(),'anos.');
